...
void CPtDialog::setCloseHandler(CCObject *pObject,SEL_CallFunc closeCallback)
{
    m_pCloseHandler = pObject;
    m_pCloseCallBack = closeCallback;
}
void CPtDialog::onClose()
{
    if (m_pCloseHandler && m_pCloseCallBack)
    {
        (m_pCloseHandler->*m_pCloseCallBack)();
    }
