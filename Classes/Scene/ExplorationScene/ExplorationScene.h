...
protected:
    ...
    void backHall(CCObject *pObject = NULL);
    ...
    // friend event:
    void handlerFriendEvent(CCDictionary *inEventInfo);
    void handlerFinishFriendEvent();
...
protected:
    ...
    void onClickIngoreFriend(CCObject *pObject);
    void onClickZanFriend(CCObject *pObject);
};
